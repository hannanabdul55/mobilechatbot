...
class Memm(MyMaxEnt):
    ...
    def __init__(self, history_list, func_obj, pic_file = None): 
        ...
        super(Memm, self).__init__(history_list, func_obj, pic_file = pic_file)
        ...
        return
    def set_wmap(self,sents):
        super(Memm, self).func.set_wmap(sents)
